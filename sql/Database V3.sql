...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 09 mei 2019 om 11:15
...
INSERT INTO `comments` (`comment_id`, `comment_user_id`, `comment_text`, `comment_post_id`, `comment_date`) VALUES
(1, 8, 'Comment by Test', 1, '2019-05-09 00:00:00'),
(2, 9, 'Comment by Pol', 1, '2019-05-09 00:00:01');
...
INSERT INTO `posts` (`id`, `file_location`, `post_user_id`, `description`, `date`, `filter`, `location`) VALUES
(1, '1.jpg', 9, 'Post by Pol', '2019-05-08 00:00:00', NULL, 'Belgium'),
(2, '1.jpg', 8, 'Post by test', '2019-05-08 00:00:00', NULL, 'Belgium');
